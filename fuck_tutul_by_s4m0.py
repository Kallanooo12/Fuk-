...
⠀   ⠀⠀⠀⠀⠀⠙⢿⡄⢿⣿⣿⣿⣿⣿⣎⠙⠻⠛⣁⣼⣿⣿⡿⠛⠁⡸⠀⠀⠀
   ...
   ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⢿⣿⣿⣿⣿⣿⣿⣿⠟⠀⠀⠀⠀⠀⠀
   ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠛⠛⠉⠉
\033[0;93m╠══[Author:🥵🥵🥵🥵🥵> \33[1;38m SK . Kallan 😈\33[1;38m       ║\033[1;31m
╠══[Facebook:🥵🥵🥵🥵🥵> kallan mitro 😈  ║  \033[1;97m
╠══[Github:🥵🥵🥵🥵🥵🥵🥵> \33[1;38m Fuk you      ║\33[1;34m
╠══[Whatsapp:🥵🥵🥵🥵🥵🥵🥵> 01613950781     ║\33[1;35m
╠══[TOOLS:🥵🥵🥵🥵🥵🥵🥵> 😞😞🥵  ║ \33[1;32m
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system('xdg-open --view  https://m.me/j/AbZmThB5YDHM8Z-H/')
                ret=input(white+"\nENTER TO BACK > "+green)
            main()    
   #         else:
